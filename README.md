...
|:-------|:------------|:--------|
| [Avalara AvaTax MCP server](https://developer.avalara.com/mcp-servers/avatax/)<br>[![smithery badge](https://smithery.ai/badge/avalara/avatax)](https://smithery.ai/servers/avalara/avatax) | Provides access to the Avalara AvaTax API for tax calculation, transaction management, nexus handling, and compliance data. | <a href="https://cursor.com/en/install-mcp?name=avalara-avatax&config=eyJ0eXBlIjoiaHR0cCIsInVybCI6Imh0dHBzOi8vbWNwLmF2YWxhcmEuY29tL2F2YXRheCJ9"><img src="https://developer.avalara.com/_next/static/images/cusrsorinstalldark-f5babeced52c8b10.svg" alt="Add to Cursor"></a> |
